...
export const SaveFilecontractAddress = await SaveFilecontract.getAddress()
console.log("SaveFile合于：：",SaveFilecontractAddress)
export const SkincontractAddress = await Skincontract.getAddress()
console.log("Skin合于：：",SkincontractAddress)
export const SkinMarketcontractAddress = await SkinMarketcontract.getAddress()
console.log("SkinMarket合于：：",SkinMarketcontractAddress)
